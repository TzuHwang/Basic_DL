import torch
from .misc import CrossentropyND, TopKLoss, WeightedCrossEntropyLoss
...
def get_tp_fp_fn(net_output, gt, axes=None, mask=None, square=False):
    ...
    tp = net_output * y_onehot # label true and pred true
    fp = net_output * (1 - y_onehot) # label false and pred true
    fn = (1 - net_output) * y_onehot # label true and pred false
...
class SoftDiceLoss(nn.Module):
    ...
    def forward(self, x, y, loss_mask=None):
        ...
        return 1-dc.mean(), 1-dc.mean(dim=0)
